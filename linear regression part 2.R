...
#Time Series data- Autocollinearity, Multicollinearity(height,weight)
...
#3. Find a Linear Model
#4. Value of R2, P-Value, Coefficients
#5. Predict for unknown input
#6. Assumptions using plot
