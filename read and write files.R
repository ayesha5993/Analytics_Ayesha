...
iimaread = read.csv('./data/mtcars.csv')
str(iimaread)
write.csv(mtcars,'E:/mtcars.csv', row.names = F)
iimaread2 = read.csv('E:/mtcars.csv', header=T)
head(iimaread2)
str(iimaread2)
...
#confirm to me that you have been able to import your data from gsheet(google sheet)
